# https://www.youtube.com/watch?v=8Tlqb14NvY8
# This seems to be a simple code, but I cannot download it, but I have to type it
# There are error, which he fixes, but not shown in the end of the video, which i dont like

# https://github.com/Akascape/CTkPopupKeyboard/tree/main
# This seems to be a longer but also simple code,
# but some driver code is needed for it
# and it uses import customtkinter, which i don't like

# https://www.reddit.com/r/Python/comments/svoo79/i_made_a_virtual_keyboard_my_first_ever_gui_based/
# https://github.com/AbhiK002/virtual-keyboard
